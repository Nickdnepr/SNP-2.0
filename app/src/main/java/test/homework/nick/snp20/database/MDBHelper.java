...
//        new PlaylistService(context).save(new Playlist(Resource.Playlist.ALL_MUSIC_PLAYLIST_TITLE, null));
//        new PlaylistService(context).save(new Playlist(Resource.Playlist.DOWNLOADED_MUSIC_PLAYLIST_TITLE, null));
